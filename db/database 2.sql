...
-- -----------------------------------------------------
-- Table `ManifestoDriebruggen`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ManifestoDriebruggen`.`users` ;

CREATE  TABLE IF NOT EXISTS `ManifestoDriebruggen`.`users` (
...
CREATE  TABLE IF NOT EXISTS `ManifestoDriebruggen`.`bestelling` (
  ...
  CONSTRAINT `bestelling_ibfk_1`
    FOREIGN KEY (`user` )
    REFERENCES `ManifestoDriebruggen`.`users` (`user_id` )
    ON DELETE CASCADE,
...
-- -----------------------------------------------------
-- Table `ManifestoDriebruggen`.`artiesten_groep`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ManifestoDriebruggen`.`artiesten_groep` ;

CREATE  TABLE IF NOT EXISTS `ManifestoDriebruggen`.`artiesten_groep` (
  `artiesten_groep_id` INT NOT NULL ,
  `optreden` INT NOT NULL ,
  `artiest` INT NOT NULL ,
  PRIMARY KEY (`artiesten_groep_id`) ,
  UNIQUE INDEX `artiesten_id_UNIQUE` (`artiesten_groep_id` ASC) )
ENGINE = InnoDB;
